...
parser.add_argument('--seed', type=int, default=333, 
                    help='numpy random seed (default: 333)')
...
if not os.path.exists("exps/seed%d/mcyt"%args.seed):
    os.mkdir("exps/seed%d/mcyt"%args.seed)

numpy.save("exps/seed%d/mcyt/feats_epoch%s.npy"%(args.seed, args.epoch), feats)
numpy.save("exps/seed%d/mcyt/labels_epoch%s.npy"%(args.seed, args.epoch), labels)
numpy.save("exps/seed%d/mcyt/inds_epoch%s.npy"%(args.seed, args.epoch), inds)
# numpy.save("exps/seed%d/mcyt/mean_epoch%s.npy"%(args.seed, args.epoch), model.bn.running_mean.cpu().numpy())
# numpy.save("exps/seed%d/mcyt/stdvar_epoch%s.npy"%(args.seed, args.epoch), model.bn.running_var.cpu().numpy()**0.5)
...
if not os.path.exists("exps/seed%d/bsid"%args.seed):
    os.mkdir("exps/seed%d/bsid"%args.seed)

numpy.save("exps/seed%d/bsid/feats_epoch%s.npy"%(args.seed, args.epoch), feats)
numpy.save("exps/seed%d/bsid/labels_epoch%s.npy"%(args.seed, args.epoch), labels)
numpy.save("exps/seed%d/bsid/inds_epoch%s.npy"%(args.seed, args.epoch), inds)
...
if not os.path.exists("exps/seed%d/bsds2"%args.seed):
    os.mkdir("exps/seed%d/bsds2"%args.seed)

numpy.save("exps/seed%d/bsds2/feats_epoch%s.npy"%(args.seed, args.epoch), feats)
numpy.save("exps/seed%d/bsds2/labels_epoch%s.npy"%(args.seed, args.epoch), labels)
numpy.save("exps/seed%d/bsds2/inds_epoch%s.npy"%(args.seed, args.epoch), inds)
...
if not os.path.exists("exps/seed%d/ebio1"%args.seed):
    os.mkdir("exps/seed%d/ebio1"%args.seed)

numpy.save("exps/seed%d/ebio1/feats_epoch%s.npy"%(args.seed, args.epoch), feats)
numpy.save("exps/seed%d/ebio1/labels_epoch%s.npy"%(args.seed, args.epoch), labels)
numpy.save("exps/seed%d/ebio1/inds_epoch%s.npy"%(args.seed, args.epoch), inds)
...
if not os.path.exists("exps/seed%d/ebio2"%args.seed):
    os.mkdir("exps/seed%d/ebio2"%args.seed)

numpy.save("exps/seed%d/ebio2/feats_epoch%s.npy"%(args.seed, args.epoch), feats)
numpy.save("exps/seed%d/ebio2/labels_epoch%s.npy"%(args.seed, args.epoch), labels)
numpy.save("exps/seed%d/ebio2/inds_epoch%s.npy"%(args.seed, args.epoch), inds)
